...
C
      ...
      CALL FLUSH(6)
      OPEN(UNIT=31,FILE='fort.31',STATUS='UNKNOWN',
      ...
      DO J= 1,JH,KSUB
        DO I= 1,IH,KSUB
          IF     (HD(I,J).LE.   0.0) THEN
            ...
            N2 = N2 + 1
*         ELSEIF (HD(I,J).LE.500.0) THEN
*           II = 50 + NINT((HD(I,J)      )*D1)
...
*           N4 = N4 + 1
          ELSE
*           II = MIN(248, 100 + NINT((HD(I,J)-500.0)*D2) )
      ...
      WRITE(6,*) '    SEA POINTS > 500 M = ',N5
*     WRITE(6,*) '    SEA POINTS < 500 M = ',N4
*     WRITE(6,*) '    SEA POINTS > 500 M = ',N5
      WRITE(6,*)
      CALL FLUSH(6)
C
